...
CREATE TABLE "ProblemConstrain" (
    ...
    CONSTRAINT "ProblemConstrain_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProblemConstrain_problemId_key" ON "ProblemConstrain"("problemId");
...
-- AddForeignKey
ALTER TABLE "ProblemConstrain" ADD CONSTRAINT "ProblemConstrain_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
